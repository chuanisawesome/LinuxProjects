...
gcloud compute instances create $rsyslog_server \
    ...
    --metadata-from-file startup-script="/LinuxProjects/NTI-310/new_instance/rsyslog-startup-script.sh"
...
ldapserver=/LinuxProjects/NTI-310/new_instance/ldap-startup-script.sh
sed -i "s/\$rsys_ip/$rsyslog_ip/g" $ldapserver

nfsserver=/LinuxProjects/NTI-310/new_instance/nfs-startup-script.sh
sed -i "s/\$rsys_ip/$rsyslog_ip/g" $nfsserver

postgresserver=/LinuxProjects/NTI-310/new_instance/postgres-startup-script.sh
sed -i "s/\$rsys_ip/$rsyslog_ip/g" $postgresserver

djangoserver=/LinuxProjects/NTI-310/new_instance/django-startup-script.sh
...
gcloud compute instances create $ldap_server \
    ...
    --metadata-from-file startup-script="/LinuxProjects/NTI-310/new_instance/ldap-startup-script.sh"
...
gcloud compute instances create $nfs_server \
    ...
    --image-project centos-cloud \
    --tags "http-server","https-server" \
    --metadata-from-file startup-script="/LinuxProjects/NTI-310/new_instance/nfs-startup-script.sh"
...
lnclient=/LinuxProjects/NTI-310/new_instance/ldap-nfs-client-startup-script.sh
...
gcloud compute instances create $ldap_nfs_client \
    ...
    --metadata-from-file startup-script="/LinuxProjects/NTI-310/new_instance/ldap-nfs-client-startup-script.sh"
...
gcloud compute instances create $postgres_server \
    ...
    --image-project centos-cloud \
    --tags "http-server","https-server" \
    --metadata-from-file startup-script="/LinuxProjects/NTI-310/new_instance/postgres-startup-script.sh"
...
django=/LinuxProjects/NTI-310/new_instance/django-startup-script.sh
...
gcloud compute instances create $django_server \
    ...
    --image-family centos-7 \
    --image-project centos-cloud \
    --tags "http-server","https-server","port-8000" \
...
dir=/LinuxProjects/NTI-310/new_instance/ip.sh
if [ -f $dir ]
then 
